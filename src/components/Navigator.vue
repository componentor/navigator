	...
	export default {
		...
		provide() {
			...
			return {
				...
				borderRadiusDropProvider: computed(() => this.borderRadiusDropArea),
				backgroundDropAreaProvider: computed(() => this.backgroundDropArea),
